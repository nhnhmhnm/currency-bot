...
class WalletServiceImpl(
  ...
  override fun companyToUser(
    userId: Long,
    currencyId: Long,
    amount: BigDecimal
  ): BigDecimal {
    require(amount > BigDecimal.ZERO) {"amount는 0보다 커야 합니다." }
  ...
  override fun bankToCompany(accountId: Long, amount: BigDecimal): BigDecimal {
    TODO("Not yet implemented")
  }
}
